...
<div class='side-body <?php echo getSideBodyClass(false); ?>'>
    ...
    <div class="content-right">
        ...
        $aColumns = [
            ...
            [
                'header' => 'survey_sent_date',
                'name'   => 'survey_sent_date'
            ],
            [
                'header' => 'survey_submitted_status',
                'name'   => 'survey_submitted_status'
            ],
            ...
            [
                'header' => 'chat_start_datetime',
                'name'   => 'chat_start_datetime'
            ],
            [
                'header' => 'service_inquiries',
        ...
        $excludedColumns = [
            ...
            'Served_By', 'survey_submitted_date',
            'survey_sent_date', 'survey_submitted_status', 'csat_answer', 'ces_answer',
            'nps_answer', 'open_question', 'whatsapp_number', 'chat_id', 'customer_name',
            'chat_start_datetime', 'service_inquiries', 'language', 'agent_id', 'agent_name'
        ];
        ...
        if (!isset($filteredColumns) || in_array('completed', $filteredColumns)) {
            $aColumns[] = [
                ...
                'filter' => TbHtml::dropDownList(
                    ...
                    ['' => gT('All'), 'Y' => gT('Yes'), 'N' => gT('No'), 'Partial' => gT('Partial')],
                    ['class' => 'form-select']
                )
            ];
        }
        ...
        foreach ($model->metaData->columns as $column) {
            // Exclude columns listed in $excludedColumns array
